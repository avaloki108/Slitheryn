...
from slither.ai.ollama_client import OllamaClient, AIAnalysisResult
...
class AIEnhancedAnalysis(AbstractDetector):
    ...
    def __init__(self, compilation_unit, slither_instance):
        super().__init__(compilation_unit, slither_instance)
